...
function createSesstionOnMongoDb(){
...
function createSessionConfig(){
    return{
        secret: 'A{LFJKopsdgjo-3I590-3563420-5IJ4U3-0OTJKMEW[L21+65HBH',  //secret key used for signing and verifying session cookies.
        ...
        storeSession: createSesstionOnMongoDb(),
        cookie:{
